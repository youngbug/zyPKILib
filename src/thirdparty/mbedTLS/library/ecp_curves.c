...
int mbedtls_ecp_group_load( mbedtls_ecp_group *grp, mbedtls_ecp_group_id id )
{
    ...
    {
#if defined(MBEDTLS_ECP_DP_CURVE_SM2_256_ENABLED)
		case MBEDTLS_ECP_DP_SM2256: /*Zhao Yang 2018.1.31*/
			//NIST_MODP(p256);
			grp->modp = NULL;//fast mod function 没有,配置为null,使用通用的算法
			return (LOAD_GROUP_A(sm2256));
#endif /* MBEDTLS_ECP_DP_CURVE_SM2_256_ENABLED*/
